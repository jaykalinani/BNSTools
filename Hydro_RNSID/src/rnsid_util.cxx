...
{  
      ...
      grid_interp( alpha, s_gp, mu, r_e, nx, ny, nz, p,
                   alpha_c,  1);

      grid_interp( omega, s_gp, mu, r_e, nx, ny, nz, p,
                   omega_c,  1);

      grid_interp( nu_dr, s_gp, mu, r_e, nx, ny, nz, p,
                   nu_dr_c, 1);

      grid_interp( B_dr, s_gp, mu, r_e, nx, ny, nz, p,
                   B_dr_c, 1);

      grid_interp( alpha_dr, s_gp, mu, r_e, nx, ny, nz, p,
                   alpha_dr_c, 1);

      grid_interp( omega_dr, s_gp, mu, r_e, nx, ny, nz, p,
                   omega_dr_c, 1);
		   
      grid_interp( nu_dth, s_gp, mu, r_e, nx, ny, nz, p,
                   nu_dth_c, -1);
      
      grid_interp( B_dth, s_gp, mu, r_e, nx, ny, nz, p,
                   B_dth_c, -1);

      grid_interp( alpha_dth, s_gp, mu, r_e, nx, ny, nz, p,
                   alpha_dth_c, -1);

      grid_interp( omega_dth, s_gp, mu, r_e, nx, ny, nz, p,
                   omega_dth_c, -1);
		   	   
      grid_interp( rho_0, s_gp, mu, r_e, nx, ny, nz, p,
                   rho_0_c, 1);
      
      grid_interp( energy, s_gp, mu, r_e, nx, ny, nz, p,
                   energy_c, 1);

      grid_interp( pressure, s_gp, mu, r_e, nx, ny, nz, p,
                   pressure_c, 1);       	       

      grid_interp( Omega_diff, s_gp, mu, r_e, nx, ny, nz, p,
                   Omega_diff_c, 1);
