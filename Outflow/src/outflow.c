...
static int get_ja_w_eninf_and_extras_onto_detector(
  ...
  static CCTK_REAL *rho0 = NULL, *velxarr = NULL, *velyarr = NULL,
                   *velzarr = NULL;
...
#undef ALLOCATE_TEMP
  ...
  CCTK_STRING input_array_names[NUM_INPUT_ARRAYS] = {
      ...
      "HydroBaseX::velx", "HydroBaseX::vely", "HydroBaseX::velz",
      "HydroBaseX::rho",

      "ADMBaseX::betax",  "ADMBaseX::betay",  "ADMBaseX::betaz",
      "ADMBaseX::alp",
  };
  ...
  void *output_arrays[NUM_OUTPUT_ARRAYS + MAX_NUMBER_EXTRAS] = {
      ...
      (void *)velxarr, (void *)velyarr, (void *)velzarr, (void *)rho0,
    ...
    if (my_w_lorentz < 1. || v2 > 1) {
      ...
      if (verbose > 1 || (verbose > 0 && last_warned != cctk_iteration)) {
        CCTK_VWarn(1, __LINE__, __FILE__, CCTK_THORNSTRING,
                   ...
                   g23[i], g33[i], velxarr[i], velyarr[i], velzarr[i],
